...
$(document).ready(function(){
	$("#album_1").hover(function(){
		$(".select_chp").not("#album_1").css('height', '15%');
		$("#album_1").css('height', '55%');
	}, function(){
	$(".select_chp").not("#album_1").css('height', '25%');
	$("#album_1").css('height', '25%');
	});
	
	$("#album_2").hover(function(){
		$(".select_chp").not("#album_2").css('height', '15%');
		$("#album_2").css('height', '55%');
	}, function(){
	$(".select_chp").not("#album_2").css('height', '25%');
	$("#album_2").css('height', '25%');
	});
	
	$("#album_3").hover(function(){
		$(".select_chp").not("#album_3").css('height', '15%');
		$("#album_3").css('height', '55%');
	}, function(){
	$(".select_chp").not("#album_3").css('height', '25%');
	$("#album_3").css('height', '25%');
	});
	
	$("#album_4").hover(function(){
		$(".select_chp").not("#album_4").css('height', '15%');
		$("#album_4").css('height', '55%');
	}, function(){
	$(".select_chp").not("#album_4").css('height', '25%');
	$("#album_4").css('height', '25%');
	});
});
